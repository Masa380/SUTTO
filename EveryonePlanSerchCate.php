...
try{
    ...
    //$spot_category_id = 4;
    $spot_category_id  = $_POST['spot_category_id'];

    $stmt = $db->prepare("SELECT spot_id FROM spot WHERE spot_category_id = ?");
    $stmt->execute([$spot_category_id]);
